...
public class chooseprofileactivity extends AppCompatActivity {
    ...
    public static String profileChosen = "kakajunn";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (files.length == 0) {
            ...
            text_user2.setText(u1);
            text_user3.setText(u1);
            text_user4.setText(u1);
            ...
            text_user3.setText(u2);
            text_user4.setText(u2);
    ...
    public void user1button(View v) {
         ...
         if (Objects.equals(text_user1.getText().toString(),"Add a User")) {
             ...
             profileChosen = text_user1.getText().toString();
             Intent myIntent = new Intent(chooseprofileactivity.this,MainActivity.class);
             startActivity(myIntent);
         }
    }
